...
-- Tablas Prisma (idénticas a las que genera Prisma, salvo vector(768))
...
-- ANN por defecto: IVFFLAT (seguro en pgvector estable)
-- Ajustá 'lists' a tu corpus (p.ej. 100–1000). Requiere ANALYZE.
...
-- Opcional: HNSW si tu imagen pgvector lo soporta (>= 0.6 aprox). Comenta IVFFLAT si activás HNSW.
...
-- Opcional: parámetros por defecto de búsqueda ANN
-- ALTER DATABASE "copiloto" SET ivfflat.probes = 10;          -- IVFFLAT
-- ALTER DATABASE "copiloto" SET hnsw.ef_search = 40;          -- HNSW

-- Recomendado tras cargar embeddings
-- ANALYZE "DocChunk";
